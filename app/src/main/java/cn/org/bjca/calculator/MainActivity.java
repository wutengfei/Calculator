...
public class MainActivity extends AppCompatActivity {
    ...
    public void calculator(View view) {
        if (salary.getText().toString().trim().equals(".") ||
                subsidy.getText().toString().trim().equals(".") ||
                subsidy.getText().toString().trim().equals(".") ||
                taxBase.getText().toString().trim().equals(".") ||
                gjjBase.getText().toString().trim().equals(".") ||
                gongjijin.getText().toString().trim().equals(".") ||
                medical.getText().toString().trim().equals(".") ||
                yanglao.getText().toString().trim().equals(".") ||
                shiye.getText().toString().trim().equals(".") ||
                gongshang.getText().toString().trim().equals(".") ||
                shengyu.getText().toString().trim().equals(".") ||
                kouchu.getText().toString().trim().equals("."))
